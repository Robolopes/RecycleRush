...
public class OI {
	...
	public static final int DRIVE_BUTTON_ROTATE_AROUND_CONTAINER = 7;
    ...
    private SetSwervePivotPoint swervePivotCommand;
	...
	public OI() {
        ...
        setSwervePivotCommand(new SetSwervePivotPoint("Container Pivot", RobotMap.Subsystem.robotDrive, getJoystickDrive(), 
	...
	public SetSwervePivotPoint getSwervePivotCommand() {
		return swervePivotCommand;
	}

	/**
	 * 
	 * @param swervePivotCommand
	 */
	private void setSwervePivotCommand(SetSwervePivotPoint swervePivotCommand) {
		this.swervePivotCommand = swervePivotCommand;
	}
